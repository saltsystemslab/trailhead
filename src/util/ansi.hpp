...
constexpr const char* ALT_SCREEN_ON  = "\033[?1049h"; // switch to alternate screen buffer
constexpr const char* ALT_SCREEN_OFF = "\033[?1049l"; // restore normal screen buffer
